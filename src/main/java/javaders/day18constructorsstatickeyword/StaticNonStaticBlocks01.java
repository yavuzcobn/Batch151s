...
public class StaticNonStaticBlocks01 {
    ...
    //static variable'lar "static block" kullanilmadan da "initialalize" edilebilirler.
    public static double pi = 3.14;

    //static variable'lar "static block" kullanilarak da "initialize" edilebilirler.
    //Asagidaki gibi "static" bir variable'a deger atamak icin kod yazmaniz gerekirse "static blocak" kullaniniz.
